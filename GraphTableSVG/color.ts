namespace GraphTableSVG {
    export namespace Color {
        ...
        let color_dic: { [key: string]: number; };

        //redの16進数の配列
        const r_value: string[] = new Array("F0", "FA", "00", "7F", "F0", "F5", "FF", "00", "FF", "00", "8A", "A5", "DE", "5F", "7F", "D2",
        ...
        //greenの16進数の配列
        const g_value: string[] = new Array("F8", "EB", "FF", "FF", "FF", "F5", "E4", "00", "EB", "00", "2B", "2A", "B8", "9E", "FF", "69",
        ...
        //blueの16進数の配列
        const b_value: string[] = new Array("FF", "D7", "FF", "D4", "FF", "DC", "C4", "00", "CD", "FF", "E2", "2A", "87", "A0", "00", "1E",
