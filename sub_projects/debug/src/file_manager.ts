...
export function getAbusoluteOutputHTMLFolderPath() : string {
  return `${getAbsoluteDirectoryPath(outputRelativeDirPath)}/html`;
}
export function getAbusoluteOutputScreenShotFolderPath() : string {
...
export class FilePathManager{
    ...
    public get correctHTMLPath() : string{
      const correctHTMLPath  = concatenatePaths(`${this.correctOutputDirPath}/${this.filenameWithoutExe}`, `${this.filenameWithoutExe}_${this.browserName}.html`)
      return correctHTMLPath;
    }
    public get correctPNGPath() : string{
      const correctPNGPath = concatenatePaths(`${this.correctOutputDirPath}/${this.filenameWithoutExe}`, `${this.filenameWithoutExe}_${this.browserName}.png`)
      return correctPNGPath;
    }
  }
