...
window.onload = () => {
    ...
    //const alignments = [ "regularInterval"]
    ...
    for(let i=0;i<alignments.length;i++){
        ...
        //graph.update();
        //console.log(`${alignments[i]} ${edge1.svgTextPath.textLength.baseVal.value} ${edge1.svgText.textLength.baseVal.value}`);
 
        const edge2 = GraphTableSVG.Edge.create(graph, {beginVertex : node2, endVertex : node3, 
                text : alignments[i], pathTextAlignment : alignments[i] });
